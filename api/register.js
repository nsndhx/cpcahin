...
router.post('/', async (req, res) => {
    try {
        ...
        return await new Promise((resolve, reject) => {
            ...
            console.log('blockchain response3: ');
            const act = {
                account: 'eosio.token',
                name: 'transfer',
                authorization: [{
                ...
                data: {//account_name to, asset quantity, string memo
                    from:'eosio.token',
                    to: msg.name,
                    quantity: '0.0010 SYSBOL',
                    memo: 'hi',
                },
            }
            console.log('Issuing the coins. Params: ');
            console.log(JSON.stringify(act, null, 2));
            ...
            console.log('blockchain response4: ');
            res.send({
                status: 200,
